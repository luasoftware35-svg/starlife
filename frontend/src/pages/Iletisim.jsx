              ...
              {[
                ...
                <div key={i.label} className="flex gap-4 sm:gap-5 items-start">
                  ...
                  <div>
                    ...
                    {i.href ? (
                      <a href={i.href} className="text-ink text-base mt-1 block break-words hover:text-pomegranate transition-colors">{i.value}</a>
                    ) : (
                      <p className="text-ink text-base mt-1 break-words">{i.value}</p>
                    )}
                  </div>
                </div>
              ))}
